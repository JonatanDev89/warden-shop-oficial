...
export const coupons = pgTable("coupons", {
  ...
  allowOnKit: boolean("allowOnKit").default(true).notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
});
...
export const discordWebhooks = pgTable("discord_webhooks", {
  ...
  msgPendente: text("msgPendente"),
  msgAceito: text("msgAceito"),
  msgRecusado: text("msgRecusado"),
  msgEntregue: text("msgEntregue"),
  msgDeletado: text("msgDeletado"),
  active: boolean("active").default(true).notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().notNull(),
});
